...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insertSql = "INSERT INTO delivery_address (orderid, name, username, mobile_no, address, area, pincode) 
    ...
    try {
        ...
        if ($insertStmt->execute()) {
            ...
            echo json_encode(["error" => "Failed to add delivery address."], JSON_UNESCAPED_SLASHES | JSON_NUMERIC_CHECK);
        }
